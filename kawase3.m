...
Y = 4000e3;
KAPPA = 1/(8.5 * 24 * 3600); % bottom friction parameter (1/8.5 days)
LAMBDA = 1/(50 * 24 * 3600); % damping coefficient (1/200 days)
...
% Conclusion: LAMBDA=1/(50 days)
%Kelvin waves at western boundary 
% poincaré waves are seen at the beginning 
% Rossby along boundaries
% Upwelling of water along equautor
